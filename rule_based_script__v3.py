# -*- coding: utf-8 -*-
"""Rule_Based_Script__V3.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1TJ-az-0cvhrzsDWe8QVYsjcQiKKCTcmK
"""
...
==================
1. Species
2. Major Health Issues  (For, Not_for, Category)
3. Allergy
4. Pregnant, Lactation ( For and Not for)
5. BS (Body Score)
6. Life_stage
7. Breed_size
8. Active ( Not for)
9. Minor_issue - (For and Not_for)
10. Matched categories ( based on the health issue and condition and Health Condition-Macronutrient requirement mapping)
"""
...
df_pets_info_with_recmmendations = add_recommendations_to_pets(df_pets_info, df_products)
df_pets_info_with_recmmendations.to_csv('pets_info_with_recmmendations.csv',index=False)